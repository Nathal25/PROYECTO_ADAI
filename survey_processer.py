...
print(f"valor de la maxima mediana es: {max_media_question['attr']}")
print(f"La pregunta con mayor mediana es la que tiene id: {max_media_question['question'].id}")
...
print(f"valor de la maxima mode es: {max_mode_question['attr']}")
print(f"La pregunta con mayor mode es la que tiene id: {max_mode_question['question'].id}")
print(f"La pregunta con mayor mode desde topic es la que tiene id:{max_mode_question_topic_1['question'].id}")
print(f"La pregunta con mayor mode desde topic es la que tiene id:{max_mode_question_topic_2['question'].id}")

max_extremism=survey_1.max_opinion_extremism()

print(f"la pregunta con mayor extremismo es : {max_extremism['question'].id}")
print()
print()
survey_1.print_info()
